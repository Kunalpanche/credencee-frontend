    ...
    <div className={cn("mx-auto flex items-center justify-center", className)}>
      <AnimatePresence>
        ...
        >
          ...
          >
            <SettingsFilled className="text-primary dark:text-primary-foreground" />
          </motion.div>
          <motion.div
            initial="hidden"
            animate={isHovered ? "visible" : "hidden"}
          ...
          <div className="relative flex min-h-[35px] py-2 sm:py-0 sm:h-[35px] flex-wrap sm:flex-nowrap items-center justify-center gap-x-2 gap-y-1 rounded-[6px] border border-primary/20 bg-primary/10 pl-3 pr-2 text-[13px] sm:text-sm dark:border-primary/30 dark:bg-primary/25 max-w-[92vw] sm:max-w-none text-center">
            <button
              className="focus-visible:shadow-focus-ring rounded-xs my-[-1px] cursor-pointer border-none bg-transparent px-0 py-1 font-sans text-[14px] sm:text-[13px] font-bold text-primary underline decoration-primary/40 underline-offset-[5px] outline-none hover:text-primary/80 hover:decoration-primary/60 focus-visible:!shadow-[#008FFF] dark:text-primary-foreground dark:decoration-primary-foreground/40 dark:hover:text-primary-foreground/80 whitespace-nowrap"
            ...
            <span className="text-[13px] sm:text-[13px] text-primary dark:text-primary-foreground/95">
              {description}
            </span>
            {onClose && (
              <button 
                onClick={onClose}
                className="m-0 flex h-6 !w-6 shrink-0 cursor-pointer items-center justify-center rounded-[4px] border-0 bg-transparent p-0 text-primary hover:bg-primary/20 dark:text-primary-foreground dark:hover:bg-primary-foreground/20 ml-auto sm:ml-0"
              >
                <X size={14} className="text-primary dark:text-primary-foreground" />
              </button>
            )}
          </div>
        </motion.div>
